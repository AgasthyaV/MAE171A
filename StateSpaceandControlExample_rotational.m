...
m2=mean([5.26,7.61,8.65,3.6,7.86])*10^-6;         % Mass m1                     
d2=mean([4.71,7.71,7.23,3.75,6.93])*10^-5;         % Damping that connects m1 to ground  
k2=8.28*10^-4;         % Spring that connect m1 to ground

m1=1.39*10^-5;         % Mass m2                     
d1=2*10^-5;         % Damping that connects m2 to ground 
k1=0;      % Spring that connects m1 and m2      
